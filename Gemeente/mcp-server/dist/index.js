...
class GemeenteMCPServer {
    ...
    getTools() {
        return [
            {
                name: "get_complaints",
                description: "Haal alle klachten op uit de Gemeente Portal. Ondersteunt filtering op status en prioriteit.",
                inputSchema: {
                    type: "object",
                    properties: {
                        status: {
                            type: "string",
                            description: "Filter op status: open, in_progress, resolved, closed",
            ...
            },
            {
                ...
                description: "Haal een specifieke klacht op aan de hand van het ID. Inclusief alle details, bijlagen en notities.",
                inputSchema: {
                    type: "object",
                    properties: {
                        id: {
            ...
            },
            {
                ...
                description: "Maak een nieuwe klacht aan in de Gemeente Portal. Vereist titel, beschrijving en contactgegevens.",
                inputSchema: {
                    type: "object",
                    properties: {
                        title: {
            ...
            },
            {
                ...
                description: "Update de status van een bestaande klacht. Alleen voor admin gebruikers.",
                inputSchema: {
                    type: "object",
                    properties: {
                        id: {
            ...
            },
            {
                ...
                description: "Voeg een interne notitie toe aan een klacht. Voor admin gebruikers.",
                inputSchema: {
                    type: "object",
                    properties: {
                        complaint_id: {
            ...
            {
                name: "get_statistics",
                description: "Haal statistieken op over alle klachten: totaal, per status, per prioriteit, recente trends.",
                inputSchema: {
                    type: "object",
                    properties: {
                        period: {
            ...
            },
            {
                ...
                description: "Zoek klachten op basis van zoekterm in titel, beschrijving of locatie.",
                inputSchema: {
                    type: "object",
                    properties: {
                        query: {
            ...
            },
            {
                ...
                description: "Haal alle klachten op met GPS coördinaten voor kaartweergave.",
                inputSchema: {
                    type: "object",
                    properties: {
                        status: {
            ...
            {
                name: "browser_goto",
                description: "Navigeer naar een specifieke pagina op de Gemeente Portal website. Gebruik dit om pagina's te bezoeken.",
                inputSchema: {
                    type: "object",
                    properties: {
                        url: {
                            type: "string",
                            description: "URL of pad (bijv. '/dashboard', '/klachten', of volledige URL)",
                        },
                        waitUntil: {
                            type: "string",
            ...
            {
                name: "browser_login",
                description: "Log in op de Gemeente Portal. Gebruikt admin credentials of opgegeven email/password.",
                inputSchema: {
                    type: "object",
                    properties: {
                        email: {
            ...
            },
            {
                ...
                description: "Maak een screenshot van de huidige pagina. Handig voor visuele verificatie.",
                inputSchema: {
                    type: "object",
                    properties: {
                        fullPage: {
            ...
            },
            {
                ...
                description: "Extract tekst van de huidige pagina of van een specifiek element.",
                inputSchema: {
                    type: "object",
                    properties: {
                        selector: {
            ...
            },
            {
                ...
                description: "Extract data uit een tabel op de pagina. Returned gestructureerde data.",
                inputSchema: {
                    type: "object",
                    properties: {
                        tableSelector: {
            ...
            },
            {
                ...
                description: "Vul formulier velden in op de huidige pagina.",
                inputSchema: {
                    type: "object",
                    properties: {
                        fields: {
                            type: "object",
                            description: "Object met selector:value paren (bijv. {'input[name=\"title\"]': 'Test', '#description': 'Details'})",
                        },
                    },
                    required: ["fields"],
                },
            ...
            },
            {
                ...
                description: "Vul het klachten formulier in en dien het in via de browser interface. Dit simuleert een echte gebruiker.",
                inputSchema: {
                    type: "object",
                    properties: {
                        title: {
            ...
            },
            {
                ...
                description: "Ga naar het dashboard en haal alle statistieken op die daar worden getoond.",
                inputSchema: {
                    type: "object",
                    properties: {
                        loginFirst: {
            ...
            },
            {
                ...
                description: "Haal algemene informatie op over de huidige pagina: URL, titel, links, etc.",
                inputSchema: {
                    type: "object",
                    properties: {},
                },
     ...
     */
    async addComplaintNote(complaintId, note) {
     ...
     * Search complaints
     */
    async searchComplaints(query, limit) {
     ...
     */
    async getComplaintMapData(status) {
     ...
     * Navigate to URL
     */
    async browserGoto(url, waitUntil) {
     ...
     * Login via browser
     */
    async browserLogin(email, password) {
     ...
     * Take screenshot
     */
    async browserScreenshot(fullPage, path) {
     ...
     */
    async browserExtractText(selector) {
     ...
     * Extract table data
     */
    async browserExtractTable(tableSelector) {
     ...
     * Click element
     */
    async browserClick(selector, waitForNavigation) {
     ...
     */
    async browserSubmitComplaint(data) {
     ...
     */
    async browserGetDashboardStats(loginFirst = true) {
        if (loginFirst) {
